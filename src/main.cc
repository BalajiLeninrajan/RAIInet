...
int main(int argc, char* argv[]) {
    ...
    opts.add_options()("help,h", "Print help")(
        "ability1,a1", po::value<std::vector<std::string>>()->multitoken(),
        "5 space separated ability IDs for player 1.")(
        "ability2,a2", po::value<std::vector<std::string>>()->multitoken(),
        "5 space separated ability IDs for player 2.")(
